...
- Le relayer cree automatiquement les rooms systeme manquantes.
...
3. Au moins une room systeme apparait pour chaque mise.
4. Un wallet peut rejoindre une room existante.
...
8. Le relayer Vercel fait automatiquement create-room, reveal, timeout, resolve, claim et close.
