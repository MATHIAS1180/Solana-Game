export const FAULTLINE_COMMIT_DOMAIN_V1 = "FAULTLINE_COMMIT_V1";
export const FAULTLINE_COMMIT_DOMAIN_V2 = "FAULTLINE_COMMIT_V2";
export const FAULTLINE_COMMIT_DOMAIN = FAULTLINE_COMMIT_DOMAIN_V2;
export const FAULTLINE_COMMIT_VERSION = 2;
export const FAULTLINE_LEGACY_COMMIT_VERSION = 1;
